...
<div class="container">
    ...
    <div class="float-left-need" style="    float: left;
    width: 805px;">
        ...
        <div class="users-late-your-inform clearfix">
            <div class="left" style="float: left;">
                <div class="infom" style="width: 400px;">
                    ...
                    <div class="w3-container w3-red w3-center" title="Осталось -30" style="width:100%; border: 1px solid red;">110</div>
                </div>
            </div>
            <div class="right">
                    ...
                    <td>
                        <div>
                            ...
                            <div class="time-start-finaly">
                                <input type="text" value="8:45" name="time-start"><span>-</span>
                                <input type="text" value="8:45" name="time-end">
